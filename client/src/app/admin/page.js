    ...
    <main className="bg-gray-50 min-h-screen p-4 sm:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-10">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Admin Dashboard: All Appointments</h1>
            {/* 2. Add the button/link to manage services */}
            <Link href="/admin/services" className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                Manage Services
            </Link>
        </div>
